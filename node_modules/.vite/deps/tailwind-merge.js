...
function createProcessDynamicClasses(config, classMap) {
  ...
  return function processDynamicClasses(key) {
    if (processedKeys.has(key) || dynamicClasses[key] === void 0) {
      return;
    }
  ...
  classGroup.forEach((classDefinition) => {
    if (typeof classDefinition === "string") {
      addToClassPart({
        ...
        path: classDefinition === "" ? void 0 : classDefinition,
        classGroupId
      });
      ...
      Object.entries(classDefinition).forEach(([key, classGroup2]) => {
        processClassesRecursively(classGroup2, getNextPart(classPartObject, key), classGroupId);
      });
    }
  });
}
...
function getNextPart(classPartObject, nextPart) {
  if (classPartObject.nextPart[nextPart] === void 0) {
...
var ROUNDED = ["none", "", ...SIZES_SIMPLE, "3xl", "full"];
...
function mergeClassList(classList, configUtils) {
  ...
  return classList.trim().split(SPLIT_CLASSES_REGEX).map((originalClassName) => {
    ...
    const classGroupId = arePrefixesValid ? configUtils.class.getGroup(className) : void 0;
    if (!classGroupId) {
      return {
